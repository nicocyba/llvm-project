...
INITIALIZE_PASS_BEGIN(InstructionSelect, DEBUG_TYPE, "Select target instructions out of generic instructions", false, false)
...
bool InstructionSelect::runOnMachineFunction(MachineFunction& MF) {
    ...
    outs() << "Running InstructionSelect\n";
...
bool InstructionSelect::selectInstr(MachineInstr& MI) {
    ...
    if (isPreISelGenericOptimizationHint(MI.getOpcode()) || MI.getOpcode() == TargetOpcode::G_CONSTANT_FOLD_BARRIER) {
