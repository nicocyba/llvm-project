...
inline std::string to_string(int value) {
  switch (value) {
    case GIM_Try: return "GIM_Try";
    case GIM_SwitchOpcode: return "GIM_SwitchOpcode";
    case GIM_SwitchType: return "GIM_SwitchType";
    case GIM_RecordInsn: return "GIM_RecordInsn";
    case GIM_RecordInsnIgnoreCopies: return "GIM_RecordInsnIgnoreCopies";
    case GIM_CheckFeatures: return "GIM_CheckFeatures";
    case GIM_CheckOpcode: return "GIM_CheckOpcode";
    case GIM_CheckOpcodeIsEither: return "GIM_CheckOpcodeIsEither";
    case GIM_CheckNumOperands: return "GIM_CheckNumOperands";
    case GIM_CheckNumOperandsLE: return "GIM_CheckNumOperandsLE";
    case GIM_CheckNumOperandsGE: return "GIM_CheckNumOperandsGE";
    case GIM_CheckI64ImmPredicate: return "GIM_CheckI64ImmPredicate";
    case GIM_CheckAPIntImmPredicate: return "GIM_CheckAPIntImmPredicate";
    case GIM_CheckAPFloatImmPredicate: return "GIM_CheckAPFloatImmPredicate";
    case GIM_CheckImmOperandPredicate: return "GIM_CheckImmOperandPredicate";
    case GIM_CheckAtomicOrdering: return "GIM_CheckAtomicOrdering";
    case GIM_CheckAtomicOrderingOrStrongerThan: return "GIM_CheckAtomicOrderingOrStrongerThan";
    case GIM_CheckAtomicOrderingWeakerThan: return "GIM_CheckAtomicOrderingWeakerThan";
    case GIM_CheckMemorySizeEqualTo: return "GIM_CheckMemorySizeEqualTo";
    case GIM_CheckMemoryAddressSpace: return "GIM_CheckMemoryAddressSpace";
    case GIM_CheckMemoryAlignment: return "GIM_CheckMemoryAlignment";
    case GIM_CheckMemorySizeEqualToLLT: return "GIM_CheckMemorySizeEqualToLLT";
    case GIM_CheckMemorySizeLessThanLLT: return "GIM_CheckMemorySizeLessThanLLT";
    case GIM_CheckMemorySizeGreaterThanLLT: return "GIM_CheckMemorySizeGreaterThanLLT";
    case GIM_CheckIsBuildVectorAllOnes: return "GIM_CheckIsBuildVectorAllOnes";
    case GIM_CheckIsBuildVectorAllZeros: return "GIM_CheckIsBuildVectorAllZeros";
    case GIM_CheckSimplePredicate: return "GIM_CheckSimplePredicate";
    case GIM_CheckCxxInsnPredicate: return "GIM_CheckCxxInsnPredicate";
    case GIM_CheckHasNoUse: return "GIM_CheckHasNoUse";
    case GIM_CheckHasOneUse: return "GIM_CheckHasOneUse";
    case GIM_CheckType: return "GIM_CheckType";
    case GIM_RootCheckType: return "GIM_RootCheckType";
    case GIM_CheckPointerToAny: return "GIM_CheckPointerToAny";
    case GIM_CheckRegBankForClass: return "GIM_CheckRegBankForClass";
    case GIM_RootCheckRegBankForClass: return "GIM_RootCheckRegBankForClass";
    case GIM_CheckComplexPattern: return "GIM_CheckComplexPattern";
    case GIM_CheckConstantInt: return "GIM_CheckConstantInt";
    case GIM_CheckConstantInt8: return "GIM_CheckConstantInt8";
    case GIM_CheckLiteralInt: return "GIM_CheckLiteralInt";
    case GIM_CheckIntrinsicID: return "GIM_CheckIntrinsicID";
    case GIM_CheckCmpPredicate: return "GIM_CheckCmpPredicate";
    case GIM_CheckIsMBB: return "GIM_CheckIsMBB";
    case GIM_CheckIsImm: return "GIM_CheckIsImm";
    case GIM_CheckIsSafeToFold: return "GIM_CheckIsSafeToFold";
    case GIM_CheckIsSameOperand: return "GIM_CheckIsSameOperand";
    case GIM_CheckIsSameOperandIgnoreCopies: return "GIM_CheckIsSameOperandIgnoreCopies";
    case GIM_CheckAllSameOperand: return "GIM_CheckAllSameOperand";
    case GIM_CheckAllSameOperandIgnoreCopies: return "GIM_CheckAllSameOperandIgnoreCopies";
    case GIM_CheckCanReplaceReg: return "GIM_CheckCanReplaceReg";
    case GIM_MIFlags: return "GIM_MIFlags";
    case GIM_MIFlagsNot: return "GIM_MIFlagsNot";
    case GIM_RecordNamedOperand: return "GIM_RecordNamedOperand";
    case GIM_RecordRegType: return "GIM_RecordRegType";
    case GIM_Reject: return "GIM_Reject";
    case GIR_MutateOpcode: return "GIR_MutateOpcode";
    case GIR_BuildMI: return "GIR_BuildMI";
    case GIR_BuildRootMI: return "GIR_BuildRootMI";
    case GIR_BuildConstant: return "GIR_BuildConstant";
    case GIR_Copy: return "GIR_Copy";
    case GIR_RootToRootCopy: return "GIR_RootToRootCopy";
    case GIR_CopyRemaining: return "GIR_CopyRemaining";
    case GIR_CopyOrAddZeroReg: return "GIR_CopyOrAddZeroReg";
    case GIR_CopySubReg: return "GIR_CopySubReg";
    case GIR_AddImplicitDef: return "GIR_AddImplicitDef";
    case GIR_AddImplicitUse: return "GIR_AddImplicitUse";
    case GIR_AddRegister: return "GIR_AddRegister";
    case GIR_AddIntrinsicID: return "GIR_AddIntrinsicID";
    case GIR_SetImplicitDefDead: return "GIR_SetImplicitDefDead";
    case GIR_SetMIFlags: return "GIR_SetMIFlags";
    case GIR_UnsetMIFlags: return "GIR_UnsetMIFlags";
    case GIR_CopyMIFlags: return "GIR_CopyMIFlags";
    case GIR_AddTempRegister: return "GIR_AddTempRegister";
    case GIR_AddSimpleTempRegister: return "GIR_AddSimpleTempRegister";
    case GIR_AddTempSubRegister: return "GIR_AddTempSubRegister";
    case GIR_AddImm: return "GIR_AddImm";
    case GIR_AddImm8: return "GIR_AddImm8";
    case GIR_AddCImm: return "GIR_AddCImm";
    case GIR_ComplexRenderer: return "GIR_ComplexRenderer";
    case GIR_ComplexSubOperandRenderer: return "GIR_ComplexSubOperandRenderer";
    case GIR_ComplexSubOperandSubRegRenderer: return "GIR_ComplexSubOperandSubRegRenderer";
    case GIR_CustomRenderer: return "GIR_CustomRenderer";
    case GIR_DoneWithCustomAction: return "GIR_DoneWithCustomAction";
    case GIR_CustomOperandRenderer: return "GIR_CustomOperandRenderer";
    case GIR_CopyConstantAsSImm: return "GIR_CopyConstantAsSImm";
    case GIR_CopyFConstantAsFPImm: return "GIR_CopyFConstantAsFPImm";
    case GIR_ConstrainOperandRC: return "GIR_ConstrainOperandRC";
    case GIR_ConstrainSelectedInstOperands: return "GIR_ConstrainSelectedInstOperands";
    case GIR_RootConstrainSelectedInstOperands: return "GIR_RootConstrainSelectedInstOperands";
    case GIR_MergeMemOperands: return "GIR_MergeMemOperands";
    case GIR_EraseFromParent: return "GIR_EraseFromParent";
    case GIR_EraseRootFromParent_Done: return "GIR_EraseRootFromParent_Done";
    case GIR_MakeTempReg: return "GIR_MakeTempReg";
    case GIR_ReplaceReg: return "GIR_ReplaceReg";
    case GIR_ReplaceRegWithTempReg: return "GIR_ReplaceRegWithTempReg";
    case GIR_Done: return "GIR_Done";
    case GIR_Coverage: return "GIR_Coverage";
    case GIU_NumOpcodes: return "GIU_NumOpcodes";
